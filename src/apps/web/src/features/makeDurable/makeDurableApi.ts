...
// Submit a typed Quick Capture: the Timeline entry is saved server-side and an optional review card is
// returned when a proposal passed the gate.
export async function submitQuickCapture(text: string): Promise<QuickCaptureResultDto> {
