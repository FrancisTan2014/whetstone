...
// controls tint independently of the reader surface. A mark-only highlight (#255, null
// template) uses the dedicated Gem swatch. Unknown templates fall back to the vocabulary hue.
...
export function templateSwatchClass(templateId: string | null): string {
  if (templateId === null) {
    return "templateHue--gem";
  }
