...
export {
  ...
  evaluateCorpusCase,
  MAX_ADMITTED_FURNITURE_BLOCK_RATIO,
  MAX_AUTOMATIC_LOW_CONFIDENCE_RATIO,
  MAX_AUTOMATIC_UNKNOWN_BLOCK_RATIO,
  MAX_EXCLUDED_FURNITURE_CHARACTER_RATIO,
  MAX_LOW_COVERAGE_PAGE_RATIO,
  MIN_DOCUMENT_TEXT_COVERAGE_RATIO,
  MIN_PAGE_TEXT_COVERAGE_RATIO,
  MIN_STRUCTURED_BODY_HEADING_LEVEL,
  MIN_STRUCTURED_OUTLINE_DEPTH,
