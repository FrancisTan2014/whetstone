...
powershell -NoProfile -Command "Get-Content -Raw 'prompts\reviewer-schedule.txt' | Set-Clipboard"
echo Reviewer schedule prompt copied to clipboard.
echo Paste it into Copilot and press Enter to start the recurring scheduled task.
copilot --experimental --agent=whetstone-reviewer --allow-all
