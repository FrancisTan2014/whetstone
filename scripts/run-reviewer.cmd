...
if not "%~1"=="" (
  set "TASK=%AUTOMATION_NOTICE% Run the whetstone reviewer role per your agent instructions. Review pull request #%~1 against GUIDELINES.md, then stop."
  goto review
)
...
if "%ACTION%"=="review" (
  set "TASK=%AUTOMATION_NOTICE% Run the whetstone reviewer role per your agent instructions. Review pull request #%NUM% against GUIDELINES.md, then stop."
  goto review
)
