...
// dependency parse is shared with the developer's selector (pickNextIssue.mjs) so "dependencies
...
// open (closed or nonexistent) -- without one API call per dependency. Mirrors pickNextIssue.mjs.
