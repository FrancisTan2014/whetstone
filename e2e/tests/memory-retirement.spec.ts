...
// The four retained primary destinations, in order. Memory and Recall are absent.
...
// The primary nav offers exactly the four retained destinations — no "Memory", no "Recall" — regardless
